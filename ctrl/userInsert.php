...
//**************************************************
    if($nStepFlg == 2 && count($arrErr) == 0){
        ...
        //データ登録
        $bRet = insertUser($sMail, $sUserName,$sPassword, $sAddress, $sTel);
...
//**************************************************
    if($nStepFlg == ""){
        require_once('../view/userInsert.html');
    } else if ($nStepFlg == 1) {
        require_once('../view/userInsertCheck.html');
    } else if ($nStepFlg == 2) {
        require_once('../view/userInsertOK.html');
    }
?>